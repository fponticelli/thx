...
class TestDateParser
{
	...
	{
		var tests = [
			/*  1 */ { expected : "2011-01-05 00:00:00", test : "January 5" },
			/*  2 */ { expected : "2011-12-25 00:00:00", test : "dec 25" },
			/*  3 */ { expected : "2011-05-27 00:00:00", test : "may 27th" },
			/*  4 */ { expected : "2006-10-01 00:00:00", test : "October 2006" },
			/*  5 */ { expected : "2011-10-06 00:00:00", test : "oct 06" },
			/*  6 */ { expected : "2010-01-03 00:00:00", test : "jan 3 2010" },
			/*  7 */ { expected : "2004-02-14 00:00:00", test : "february 14, 2004" },
			/*  8 */ { expected : "2000-01-03 00:00:00", test : "3 jan 2000" },
			/*  9 */ { expected : "1985-04-17 00:00:00", test : "17 april 85" },
			/* 10 */ { expected : "1979-05-27 00:00:00", test : "5/27/1979" },
			/* 11 */ { expected : "1979-05-27 00:00:00", test : "27/5/1979" },
			/* 12 */ { expected : "2011-05-06 00:00:00", test : "05/06" },
			/* 13 */ { expected : "1979-05-27 00:00:00", test : "1979-05-27" },
			/* 14 */ { expected : "2011-05-06 00:00:00", test : "6" },
	...
	{
		var tests = [
			{ expected : "2011-06-02 00:00:00", test : "thursday" },
			{ expected : "2011-11-01 00:00:00", test : "november" },
			...
			{ expected : "2011-05-30 00:00:00", test : "yesterday" },
			{ expected : "2011-05-31 00:00:00", test : "today" },
			{ expected : "2011-05-31 16:20:00", test : "now" },
			{ expected : "2011-06-01 00:00:00", test : "tomorrow" },

			{ expected : "2011-05-30 00:00:00", test : "this monday" },
			{ expected : "2011-05-31 00:00:00", test : "this tuesday" },
			{ expected : "2011-06-01 00:00:00", test : "this wednesday" },
			{ expected : "2011-05-30 00:00:00", test : "last monday" },
			{ expected : "2011-05-24 00:00:00", test : "last tuesday" },
			{ expected : "2011-05-25 00:00:00", test : "last wednesday" },
			{ expected : "2011-06-06 00:00:00", test : "next monday" },
			{ expected : "2011-06-07 00:00:00", test : "next tuesday" },
			{ expected : "2011-06-01 00:00:00", test : "next wednesday" },

			{ expected : "2011-04-01 00:00:00", test : "this april" },
			{ expected : "2011-05-01 00:00:00", test : "this may" },
			{ expected : "2011-06-01 00:00:00", test : "this june" },
...
//			{ expected : "2011-06-01 00:00:00", test : "next month" },
...
//			{ expected : "2011-05-30 21:00:00", test : "last night" },
			...
			{ expected : "2011-05-30 00:00:00", test : "last monday" },
//			{ expected : "2011-05-23 00:00:00", test : "last week monday" },
			{ expected : "2011-06-03 00:00:00", test : "next friday" },
//			{ expected : "2011-06-10 00:00:00", test : "next week friday" },
			{ expected : "2011-06-01 18:45:00", test : "tomorrow at 6:45pm" },
			{ expected : "2011-05-30 14:00:00", test : "afternoon yesterday" },
//			{ expected : "2011-05-23 00:00:00", test : "monday last week" },
		];
	...
	public function testParseComplexDates()
	{
		var tests = [
			...
			{ expected : "2010-12-31 00:00:00", test : "5 months before today" },
			{ expected : "2010-12-30 00:00:00", test : "5 months before yesterday" },
			{ expected : "2011-01-01 00:00:00", test : "5 months before tomorrow" },
			{ expected : "2011-05-31 09:20:00", test : "7 hours ago" },
			{ expected : "2011-06-07 00:00:00", test : "7 days from today" },
			{ expected : "2011-06-07 16:20:00", test : "7 days from now" },
			{ expected : "2011-06-07 00:00:00", test : "1 week hence" },
			{ expected : "2011-05-31 19:20:00", test : "in 3 hours" },
			{ expected : "2010-05-31 00:00:00", test : "1 year ago today" },
			{ expected : "2010-05-30 00:00:00", test : "1 year ago yesterday" },
			{ expected : "2010-06-01 00:00:00", test : "1 year ago tomorrow" },
			{ expected : "2012-05-31 00:00:00", test : "1 year from today" },
			{ expected : "2012-05-30 00:00:00", test : "1 year from yesterday" },
			{ expected : "2012-06-01 00:00:00", test : "1 year from tomorrow" },
			{ expected : "2011-06-01 05:00:00", test : "7 hours before tomorrow at noon" },
//			{ expected : "2011-11-16 00:00:00", test : "3rd wednesday in november" },
//			{ expected : "2012-03-01 00:00:00", test : "3rd month next year" },
//			{ expected : "2011-09-15 00:00:00", test : "3rd thursday this september" },
//			{ expected : "2011-05-25 00:00:00", test : "4th day last week" },
